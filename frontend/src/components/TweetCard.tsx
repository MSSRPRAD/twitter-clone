...
type TweetCardProps  = {
    ...
    quotedTweetProfileUrl : string | null;
}
    ...
    <div>
        <article class="transition duration-350 ease-in-out border-stone-100 border-2 shadow-sm">
                            <div class="flex flex-shrink-0 p-4 pb-0">
                                <a href="#" class="flex-shrink-0 group block">
                                    <div class="flex items-center">
                                        <div>
                                            <img class="inline-block h-10 w-10 rounded-full" src={props.profileUrl?? ""} />
                                        </div>
                                        <div class="ml-3">
                    ...
                    <img class="opacity-0 w-full h-full" src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=448&amp;q=80" alt="" />
                                ...
                                <div>
                                    {props.tweet?.quote_id? (
                                        <div class="border-black border-2 m-5 mr-10">
                                            <TweetCard
                                                tweet={props.quotedTweet}
                                                profileUrl={props.quotedTweetProfileUrl}
                                                quotedTweet={null}
                                                quotedTweetProfileUrl={null}
                                            />
                                        </div>
                                    ) : null}
                                </div>
